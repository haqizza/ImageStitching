...
class ImageStitcherOrb:
    ...
    def add_image(self, image: numpy.ndarray):
        ...
        # todo(will.brennan) - stop computing features on the results image each time!
        result_features = self.orb.detectAndCompute(self.result_image_gray, None)
        image_features = self.orb.detectAndCompute(image_gray, None)
